      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
            Enter your customer account email and password to access your dashboard
          </p>
        </div>
                ...
                {unverifiedEmail && (
                  <div className="mt-2">
                    <Link
                      ...
                      className="font-bold underline text-rose-700 dark:text-rose-300 hover:opacity-80"
                    >
                      Click here to enter verification OTP &rarr;
                    </Link>
                  </div>
                )}
              </div>
        ...
        <div className="mt-8 pt-6 border-t border-zinc-200 dark:border-zinc-800/60">
          <p className="text-center text-[11px] font-semibold text-zinc-400 uppercase tracking-wider mb-3">
            Looking for another portal?
          </p>
          <div className="grid grid-cols-3 gap-2 text-center text-xs">
            <Link
              href="/worker/login"
              className="p-2 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors flex flex-col items-center gap-1 text-zinc-600 dark:text-zinc-300"
            >
